...
var body=elm.id;
   ...
   $.ajax({
    ...
    $("#"+ids[0]+"combdy2").hide();
    $("#"+ids[0]+"combdy").append("<div class='col-md-9 cmtedt'><textarea type='text' class='form-control' rows='2' id='bodyedit'>"+body+"</textarea></div><div class='col-md-3 cmtedt'> <button style='float:left !important;' class='btn btn-primary buttonsave' onclick='SaveComment("+ids[0]+','+ids[1]+")'><span class='glyphicon glyphicon-ok'></span></button> &ensp; <button  onclick='cancelEditCmt("+ids[0]+','+ids[1]+")' class='btn btn-danger'><span class='glyphicon glyphicon-remove'></span> </button> </div>");
